...
Box.prototype = {
	...
	,render: function(graphics) {
		if(this.isShowing) {
			...
			graphics.drawRect(this.x,this.y,this.width,this.height,5);
		}
	}
	,__class__: Box
};
	...
	,render: function(g) {
		if(this.image != null && this.visible) {
			...
			if(this.angle != 0) {
				...
				var m__00 = 1;
				m__10 = 0;
				m__20 = this.x + this.originX;
				m__01 = 0;
				m__11 = 1;
				m__21 = this.y + this.originY;
				m__02 = 0;
				m__12 = 0;
				m__22 = 1;
				_this__001 = _this._00 * m__00 + _this._10 * m__01 + _this._20 * m__02;
				_this__101 = _this._00 * m__10 + _this._10 * m__11 + _this._20 * m__12;
				_this__201 = _this._00 * m__20 + _this._10 * m__21 + _this._20 * m__22;
				_this__011 = _this._01 * m__00 + _this._11 * m__01 + _this._21 * m__02;
				_this__111 = _this._01 * m__10 + _this._11 * m__11 + _this._21 * m__12;
				_this__211 = _this._01 * m__20 + _this._11 * m__21 + _this._21 * m__22;
				_this__021 = _this._02 * m__00 + _this._12 * m__01 + _this._22 * m__02;
				_this__121 = _this._02 * m__10 + _this._12 * m__11 + _this._22 * m__12;
				_this__221 = _this._02 * m__20 + _this._12 * m__21 + _this._22 * m__22;
				var m__221;
				var m__211;
				var m__201;
				var m__121;
				...
				m__001 = Math.cos(alpha);
				m__101 = -Math.sin(alpha);
				m__201 = 0;
				m__011 = Math.sin(alpha);
				m__111 = Math.cos(alpha);
				m__211 = 0;
				m__021 = 0;
				m__121 = 0;
				m__221 = 1;
				...
				var m__002 = 1;
				m__102 = 0;
				m__202 = -this.x - this.originX;
				m__012 = 0;
				m__112 = 1;
				m__212 = -this.y - this.originY;
				m__022 = 0;
				m__122 = 0;
				m__222 = 1;
				g.pushTransformation(new kha_math_FastMatrix3(_this__00 * m__002 + _this__10 * m__012 + _this__20 * m__022,_this__00 * m__102 + _this__10 * m__112 + _this__20 * m__122,_this__00 * m__202 + _this__10 * m__212 + _this__20 * m__222,_this__01 * m__002 + _this__11 * m__012 + _this__21 * m__022,_this__01 * m__102 + _this__11 * m__112 + _this__21 * m__122,_this__01 * m__202 + _this__11 * m__212 + _this__21 * m__222,_this__02 * m__002 + _this__12 * m__012 + _this__22 * m__022,_this__02 * m__102 + _this__12 * m__112 + _this__22 * m__122,_this__02 * m__202 + _this__12 * m__212 + _this__22 * m__222));
			}
...
var Char = function(x,y) {
	kha2d_Sprite.call(this,kha_Assets.images.buddy,126,175);
	this.x = x;
	this.y = y;
	this.leftWalk = kha2d_Animation.createRange(40,49,4);
	this.rightWalk = kha2d_Animation.createRange(30,39,4);
	this.idle = kha2d_Animation.createRange(0,9,6);
	this.setAnimation(this.idle);
	kha_input_Keyboard.get().notify($bind(this,this.onKeyDown),$bind(this,this.onKeyUp));
};
$hxClasses["Char"] = Char;
Char.__name__ = true;
Char.__super__ = kha2d_Sprite;
Char.prototype = $extend(kha2d_Sprite.prototype,{
	leftWalk: null
	,rightWalk: null
	,idle: null
	,left: null
	...
	,update: function() {
		kha2d_Sprite.prototype.update.call(this);
		if(this.left) {
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Project", width : 800, height : 600, samplesPerPixel : 3},function() {
...
var Project = function() {
	this.ui = new zui_Zui({ font : kha_Assets.fonts.DroidSans, khaWindowId : 0, scaleFactor : 1.0});
	this.box_x = 350;
	this.box_y = 350;
	this.box = new Box(this.box_x,this.box_y,64,64,this.box_color);
	this.vid = kha_Assets.videos.justdoit;
	this.motivate = false;
	this["char"] = new Char(325,425);
	kha2d_Scene.get_the().addHero(this["char"]);
	kha2d_Scene.get_the().setSize(800,600);
};
...
Project.prototype = {
	...
	,'char': null
	,update: function() {
		this.box.update(this.box_x,this.box_y);
		this.box.setColor(this.box_color);
		if(this.motivate && this.vid.getCurrentPos() == 0 || this.motivate && this.vid.isFinished()) {
			this.vid.play();
		} else if(!this.motivate) {
			this.vid.stop();
		}
		kha2d_Scene.get_the().update();
	}
	,render: function(framebuffer) {
		var graphics = framebuffer.get_g2();
		graphics.set_color(-1);
		graphics.set_fontSize(24);
		graphics.set_font(kha_Assets.fonts.DroidSans);
		graphics.begin();
		graphics.clear(-16776961);
		kha2d_Scene.get_the().render(graphics);
		graphics.drawString("Our Hero",this["char"].x + 20,this["char"].y - 20);
		if(this.motivate) {
			graphics.drawVideo(this.vid,310,0,this.vid.width() / 3,this.vid.height() / 3);
		}
		this.box.render(graphics);
		graphics.end();
		this.gui(graphics);
	}
	,gui: function(graphics) {
		this.ui.begin(graphics);
		if(this.ui.window(zui_Handle.global.nest(0,null),0,0,300,300)) {
			if(this.ui.panel(zui_Handle.global.nest(1,null),"CONTROL PANEL",10)) {
				if(this.ui.button("ZUI Demo")) {
					haxe_Log.trace("Hello ZUI!",{ fileName : "Project.hx", lineNumber : 77, className : "Project", methodName : "gui"});
				}
				if(this.ui.check(zui_Handle.global.nest(2,null),"Show/Hide Box")) {
					this.box.show();
				} else {
					this.box.hide();
				}
				this.box_x = this.ui.slider(zui_Handle.global.nest(3,{ value : 350}),"Box X",5,731);
				this.box_y = this.ui.slider(zui_Handle.global.nest(4,{ value : 350}),"Box Y",5,531);
				this.box_color = zui_Ext.colorPicker(this.ui,zui_Handle.global.nest(5,null));
				this.motivate = this.ui.check(zui_Handle.global.nest(6,null),"Show/Hide Motivational Video");
			}
		}
		this.ui.end();
	}
...
var kha__$Assets_ImageList = function() {
	this.names = ["buddy","char_spritesheet"];
	this.char_spritesheetDescription = { files : ["char_spritesheet.png"], original_height : 768, type : "image", original_width : 2048, name : "char_spritesheet"};
	this.char_spritesheetName = "char_spritesheet";
	this.char_spritesheet = null;
	this.buddyDescription = { files : ["buddy.png"], original_height : 875, type : "image", original_width : 1260, name : "buddy"};
...
kha__$Assets_ImageList.prototype = {
	buddy: null
	,buddyName: null
	,buddyDescription: null
	,buddyLoad: function(done) {
		kha_Assets.loadImage("buddy",function(image) {
			done();
		});
	}
	,buddyUnload: function() {
		this.buddy.unload();
		this.buddy = null;
	}
	,char_spritesheet: null
	,char_spritesheetName: null
	,char_spritesheetDescription: null
	,char_spritesheetLoad: function(done) {
		kha_Assets.loadImage("char_spritesheet",function(image) {
			done();
		});
	}
	,char_spritesheetUnload: function() {
		this.char_spritesheet.unload();
		this.char_spritesheet = null;
	}
	,names: null
...
var kha__$Assets_VideoList = function() {
	this.names = ["justdoit"];
	this.justdoitDescription = { files : ["justdoit.mp4","justdoit.webm"], type : "video", name : "justdoit"};
	this.justdoitName = "justdoit";
	this.justdoit = null;
};
...
kha__$Assets_VideoList.prototype = {
	justdoit: null
	,justdoitName: null
	,justdoitDescription: null
	,justdoitLoad: function(done) {
		kha_Assets.loadVideo("justdoit",function(video) {
			done();
		});
	}
	,justdoitUnload: function() {
		this.justdoit.unload();
		this.justdoit = null;
	}
	,names: null
...
kha_Shaders.init = function() {
	...
	kha_Shaders.painter_image_vert = new kha_graphics4_VertexShader(blobs2,["painter-image.vert.essl"]);
	var blobs3 = [];
	var _g3 = 0;
	while(_g3 < 1) {
		var i3 = _g3++;
	...
	kha_Shaders.painter_image_frag = new kha_graphics4_FragmentShader(blobs3,["painter-image.frag.essl"]);
	var blobs4 = [];
	var _g4 = 0;
	while(_g4 < 1) {
		var i4 = _g4++;
	...
	kha_Shaders.painter_text_frag = new kha_graphics4_FragmentShader(blobs4,["painter-text.frag.essl"]);
	var blobs5 = [];
	var _g5 = 0;
	while(_g5 < 1) {
		var i5 = _g5++;
	...
	kha_Shaders.painter_text_vert = new kha_graphics4_VertexShader(blobs5,["painter-text.vert.essl"]);
	var blobs6 = [];
	var _g6 = 0;
	while(_g6 < 1) {
		var i6 = _g6++;
	...
	kha_Shaders.painter_video_frag = new kha_graphics4_FragmentShader(blobs6,["painter-video.frag.essl"]);
	var blobs7 = [];
	var _g7 = 0;
	while(_g7 < 1) {
		var i7 = _g7++;
...
kha_js_graphics4_Graphics.prototype = {
	...
	,setFloat4s: function(location,values) {
		kha_SystemImpl.gl.uniform4fv((js_Boot.__cast(location , kha_js_graphics4_ConstantLocation)).value,values);
	}
...
kha2d_Animation.create = function(index) {
	var indices = [index];
	return new kha2d_Animation(indices,1);
};
...
var kha2d_CollisionLayer = function(map) {
	this.map = map;
	this.heroes = [];
	this.enemies = [];
	this.projectiles = [];
...
$hxClasses["kha2d.CollisionLayer"] = kha2d_CollisionLayer;
kha2d_CollisionLayer.__name__ = true;
kha2d_CollisionLayer.prototype = {
	map: null
	,heroes: null
	,enemies: null
	,projectiles: null
		...
		while(true) {
			...
			if(e2 > -dy) {
				...
				if(this.map.collides(sprite)) {
					...
					sprite.x -= sx;
					if(sx < 0) {
						sprite.hitFrom(kha2d_Direction.RIGHT);
					} else {
						sprite.hitFrom(kha2d_Direction.LEFT);
					}
					while(true) {
						if(y0 == y1) {
							sprite.y = yend;
						...
						if(this.map.collides(sprite)) {
							sprite.y -= sy;
							if(sy < 0) {
								sprite.hitFrom(kha2d_Direction.DOWN);
							} else {
								sprite.hitFrom(kha2d_Direction.UP);
							}
							return;
						}
					}
	...
	,moveSprite: function(sprite) {
		...
		if(sprite.collides) {
			...
			sprite.y = yaim;
			if(this.map.collides(sprite)) {
				this.line(xstart,ystart,xaim,yaim,sprite);
			}
		} else {
	...
	,__class__: kha2d_CollisionLayer
};
...
var kha2d_Scene = function() {
	...
	this.foregroundSpeeds = [];
	this.backgroundColor = kha__$Color_Color_$Impl_$.fromBytes(0,0,0);
	this.set_camx(0);
	this.set_camy(0);
};
$hxClasses["kha2d.Scene"] = kha2d_Scene;
kha2d_Scene.__name__ = true;
kha2d_Scene.get_the = function() {
	if(kha2d_Scene.instance == null) {
		kha2d_Scene.instance = new kha2d_Scene();
	}
	return kha2d_Scene.instance;
};
kha2d_Scene.prototype = {
	collisionLayer: null
	,backgrounds: null
	,foregrounds: null
	,backgroundSpeeds: null
	,foregroundSpeeds: null
	,sprites: null
	...
	,setColissionMap: function(tilemap) {
		this.collisionLayer = new kha2d_CollisionLayer(tilemap);
	}
	,addHero: function(sprite) {
		sprite.removed = false;
		if(this.collisionLayer != null) {
			this.collisionLayer.addHero(sprite);
		}
	...
	,addEnemy: function(sprite) {
		sprite.removed = false;
		if(this.collisionLayer != null) {
			this.collisionLayer.addEnemy(sprite);
		}
		this.sprites.push(sprite);
	}
	,addProjectile: function(sprite) {
		sprite.removed = false;
		if(this.collisionLayer != null) {
			this.collisionLayer.addProjectile(sprite);
		}
		this.sprites.push(sprite);
	}
	,addOther: function(sprite) {
		sprite.removed = false;
		if(this.collisionLayer != null) {
			this.collisionLayer.addOther(sprite);
		}
		this.sprites.push(sprite);
	}
	,removeHero: function(sprite) {
	...
	,getHero: function(index) {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.getHero(index);
		}
	}
	,getEnemy: function(index) {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.getEnemy(index);
		}
	}
	,getProjectile: function(index) {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.getProjectile(index);
		}
	}
	,getOther: function(index) {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.getOther(index);
		}
	}
	,countHeroes: function() {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.countHeroes();
		}
	}
	,countEnemies: function() {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.countEnemies();
		}
	}
	,countProjectiles: function() {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.countProjectiles();
		}
	}
	,countOthers: function() {
		if(this.collisionLayer == null) {
			...
			return this.collisionLayer.countOthers();
		}
	}
	,set_camx: function(newcamx) {
		this.camx = newcamx;
		if(this.collisionLayer != null) {
			this.screenOffsetX = Math.min(Math.max(0,this.camx - this.width / 2),this.collisionLayer.getMap().getWidth() * this.collisionLayer.getMap().getTileset().TILE_WIDTH - this.width) | 0;
			if(this.getWidth() < this.width) {
				this.screenOffsetX = 0;
			}
		} else {
			this.screenOffsetX = this.camx;
		}
		return this.camx;
	}
	,set_camy: function(newcamy) {
		this.camy = newcamy;
		if(this.collisionLayer != null) {
			this.screenOffsetY = Math.min(Math.max(0,this.camy - this.height / 2),this.collisionLayer.getMap().getHeight() * this.collisionLayer.getMap().getTileset().TILE_HEIGHT - this.height) | 0;
			if(this.getHeight() < this.height) {
				this.screenOffsetY = 0;
			}
		} else {
			this.screenOffsetY = this.camy;
		}
		return this.camy;
	}
	,sort: function(sprites) {
		...
		haxe_ds_ArraySort.sort(sprites,function(arg0,arg1) {
			if(arg0.x < arg1.x) {
				return -1;
			} else if(arg0.x == arg1.x) {
				return 0;
	...
	,collidesPoint: function(point) {
		if(this.collisionLayer != null) {
			return this.collisionLayer.collidesPoint(point);
		} else {
			return false;
		}
	}
	,collidesSprite: function(sprite) {
		if(this.collisionLayer != null) {
			return this.collisionLayer.collidesSprite(sprite);
		} else {
			return false;
		}
	}
	,cleanSprites: function() {
		if(!this.dirtySprites) {
			return;
		}
		var found = true;
		while(found) {
		...
		if(this.collisionLayer != null) {
			this.collisionLayer.cleanSprites();
		}
	}
	,update: function() {
		this.cleanSprites();
		if(this.collisionLayer != null) {
			this.collisionLayer.advance(this.screenOffsetX,this.screenOffsetX + this.width);
		}
		this.cleanSprites();
		var _g = 0;
		var _g1 = this.sprites;
	...
	,render: function(g) {
		...
		while(_g1 < _g) {
			var i = _g1++;
			var transformation1 = new kha_math_FastMatrix3(1,0,Math.round(-this.screenOffsetX * this.backgroundSpeeds[i]),0,1,Math.round(-this.screenOffsetY * this.backgroundSpeeds[i]),0,0,1);
			...
			this.backgrounds[i].render(g,this.screenOffsetX * this.backgroundSpeeds[i] | 0,this.screenOffsetY * this.backgroundSpeeds[i] | 0,this.width,this.height);
		}
		var transformation2 = new kha_math_FastMatrix3(1,0,-this.screenOffsetX,0,1,-this.screenOffsetY,0,0,1);
		...
		while(_g2 < 10) {
			...
			while(i1 < this.sprites.length) {
				if(this.sprites[i1].x + this.sprites[i1].get_width() > this.screenOffsetX) {
					break;
				}
				++i1;
			}
			while(i1 < this.sprites.length) {
				if(this.sprites[i1].x > this.screenOffsetX + this.width) {
					break;
				}
				if(i1 < this.sprites.length && this.sprites[i1].z == z) {
					this.sprites[i1].render(g);
				}
				++i1;
			}
		}
		...
		while(_g11 < _g3) {
			var i2 = _g11++;
			var transformation3 = new kha_math_FastMatrix3(1,0,Math.round(-this.screenOffsetX * this.foregroundSpeeds[i2]),0,1,Math.round(-this.screenOffsetY * this.foregroundSpeeds[i2]),0,0,1);
			...
			this.foregrounds[i2].render(g,this.screenOffsetX * this.foregroundSpeeds[i2] | 0,this.screenOffsetY * this.foregroundSpeeds[i2] | 0,this.width,this.height);
		}
	}
	,getWidth: function() {
		if(this.collisionLayer != null) {
			return this.collisionLayer.getMap().getWidth() * this.collisionLayer.getMap().getTileset().TILE_WIDTH;
		} else {
			return 0;
		}
	}
	,getHeight: function() {
		if(this.collisionLayer != null) {
			return this.collisionLayer.getMap().getHeight() * this.collisionLayer.getMap().getTileset().TILE_HEIGHT;
		} else {
			return 0;
		}
	}
	,getHeroesBelowPoint: function(px,py) {
		...
		while(_g1 < _g) {
			...
			if(hero.x < px && px < hero.x + hero.get_width() && hero.y < py && py < hero.y + hero.get_height()) {
				heroes.push(hero);
			}
		}
		haxe_ds_ArraySort.sort(heroes,function(h1,h2) {
			if(h1.z == h2.z) {
				return 0;
			} else if(h1.z < h2.z) {
				return 1;
	...
	,getSpritesBelowPoint: function(px,py) {
		...
		while(_g1 < _g) {
			...
			if(sprite.x + sprite.get_width() < px) {
				continue;
			}
			if(sprite.x > px) {
				break;
		...
		haxe_ds_ArraySort.sort(sprites,function(h1,h2) {
			if(h1.z == h2.z) {
				return 0;
			} else if(h1.z < h2.z) {
				return 1;
...
kha2d_Tilemap.prototype = {
	...
	,index: function(xpos,ypos) {
		...
		return new kha_math_Vector2i(xtile,ytile);
	}
	,get: function(x,y) {
		return this.map[x][y];
	}
...
var kha2d_Tileset = function(image,tileWidth,tileHeight,tiles) {
	...
	if(tiles == null) {
		...
		while(_g1 < _g) {
			var i = _g1++;
			this.tiles.push(new kha2d_Tile(i,false));
		}
	} else {
		this.tiles = tiles;
	}
...
zui_Ext.list = function(ui,handle,ar,addCb,removeCb,getNameCb,setNameCb,itemDrawCb,showRadio,editable,showAdd) {
	if(showAdd == null) {
		showAdd = true;
	}
	if(editable == null) {
...
zui_Ext.panelList = function(ui,handle,ar,addCb,removeCb,getNameCb,setNameCb,itemDrawCb,editable,showAdd) {
	if(showAdd == null) {
		showAdd = true;
	}
	if(editable == null) {
...
var zui_Zui = function(ops) {
	...
	if(ops.autoNotifyInput && zui_Zui.firstInstance) {
...
zui_Zui.ELEMENT_W = function() {
	return zui_Zui.t._ELEMENT_W * zui_Zui.SCALE;
};
zui_Zui.ELEMENT_H = function() {
	return zui_Zui.t._ELEMENT_H * zui_Zui.SCALE;
};
zui_Zui.ELEMENT_SEPARATOR_SIZE = function() {
	return zui_Zui.t._ELEMENT_SEPARATOR_SIZE * zui_Zui.SCALE;
};
zui_Zui.ARROW_W = function() {
	return zui_Zui.t._ARROW_W * zui_Zui.SCALE;
};
zui_Zui.ARROW_H = function() {
	return zui_Zui.t._ARROW_H * zui_Zui.SCALE;
};
zui_Zui.BUTTON_H = function() {
	return zui_Zui.t._BUTTON_H * zui_Zui.SCALE;
};
zui_Zui.CHECK_W = function() {
	return zui_Zui.t._CHECK_W * zui_Zui.SCALE;
};
zui_Zui.CHECK_H = function() {
	return zui_Zui.t._CHECK_H * zui_Zui.SCALE;
};
zui_Zui.CHECK_SELECT_W = function() {
	return zui_Zui.t._CHECK_SELECT_W * zui_Zui.SCALE;
};
zui_Zui.CHECK_SELECT_H = function() {
	return zui_Zui.t._CHECK_SELECT_H * zui_Zui.SCALE;
};
zui_Zui.RADIO_W = function() {
	return zui_Zui.t._RADIO_W * zui_Zui.SCALE;
};
zui_Zui.RADIO_H = function() {
	return zui_Zui.t._RADIO_H * zui_Zui.SCALE;
};
zui_Zui.RADIO_SELECT_W = function() {
	return zui_Zui.t._RADIO_SELECT_W * zui_Zui.SCALE;
};
zui_Zui.RADIO_SELECT_H = function() {
	return zui_Zui.t._RADIO_SELECT_H * zui_Zui.SCALE;
};
zui_Zui.SCROLL_W = function() {
	return zui_Zui.t._SCROLL_W * zui_Zui.SCALE | 0;
};
zui_Zui.SCROLL_BAR_W = function() {
	return zui_Zui.t._SCROLL_BAR_W * zui_Zui.SCALE;
};
zui_Zui.DEFAULT_TEXT_OFFSET_X = function() {
	return zui_Zui.t._DEFAULT_TEXT_OFFSET_X * zui_Zui.SCALE;
};
zui_Zui.TAB_W = function() {
	return zui_Zui.t._TAB_W * zui_Zui.SCALE | 0;
};
zui_Zui.LINE_STRENGTH = function() {
	return zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE;
};
zui_Zui.prototype = {
	inputX: null
	,inputY: null
	...
	,setScaleFactor: function(scaleFactor) {
		zui_Zui.SCALE = this.ops.scaleFactor = scaleFactor * this.ops.scaleTexture;
		this.fontSize = zui_Zui.t._FONT_SIZE * this.ops.scaleFactor | 0;
		this.fontSmallSize = zui_Zui.t._FONT_SMALL_SIZE * this.ops.scaleFactor | 0;
		var fontHeight = this.ops.font.height(this.fontSize);
		var fontSmallHeight = this.ops.font.height(this.fontSmallSize);
		this.fontOffsetY = (zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - fontHeight) / 2;
		this.fontSmallOffsetY = (zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - fontSmallHeight) / 2;
		this.arrowOffsetY = (zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - zui_Zui.t._ARROW_H * zui_Zui.SCALE) / 2;
		this.arrowOffsetX = this.arrowOffsetY;
		this.titleOffsetX = (this.arrowOffsetX * 2 + zui_Zui.t._ARROW_W * zui_Zui.SCALE) / zui_Zui.SCALE;
		this.buttonOffsetY = (zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - zui_Zui.t._BUTTON_H * zui_Zui.SCALE) / 2;
		this.checkOffsetY = (zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - zui_Zui.t._CHECK_H * zui_Zui.SCALE) / 2;
		this.checkOffsetX = this.checkOffsetY;
		this.checkSelectOffsetY = (zui_Zui.t._CHECK_H * zui_Zui.SCALE - zui_Zui.t._CHECK_SELECT_H * zui_Zui.SCALE) / 2;
		this.checkSelectOffsetX = this.checkSelectOffsetY;
		this.radioOffsetY = (zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - zui_Zui.t._RADIO_H * zui_Zui.SCALE) / 2;
		this.radioOffsetX = this.radioOffsetY;
		this.radioSelectOffsetY = (zui_Zui.t._RADIO_H * zui_Zui.SCALE - zui_Zui.t._RADIO_SELECT_H * zui_Zui.SCALE) / 2;
		this.radioSelectOffsetX = this.radioSelectOffsetY;
		this.scrollAlign = 0;
	}
	,bakeElements: function() {
		zui_Zui.elementsBaked = true;
		zui_Zui.checkSelectImage = kha_Image.createRenderTarget(zui_Zui.t._CHECK_SELECT_W * zui_Zui.SCALE | 0,zui_Zui.t._CHECK_SELECT_H * zui_Zui.SCALE | 0,null,0,1,this.ops.khaWindowId);
		var g = zui_Zui.checkSelectImage.get_g2();
		g.begin(true,0);
		g.set_color(zui_Zui.t.CHECK_SELECT_COL);
		g.drawLine(0,0,zui_Zui.t._CHECK_SELECT_W * zui_Zui.SCALE,zui_Zui.t._CHECK_SELECT_H * zui_Zui.SCALE,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		g.drawLine(zui_Zui.t._CHECK_SELECT_W * zui_Zui.SCALE,0,0,zui_Zui.t._CHECK_SELECT_H * zui_Zui.SCALE,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		g.end();
	}
	,remove: function() {
	...
	,begin: function(g) {
		...
		zui_Zui.SCALE = this.ops.scaleFactor;
		this.globalG = g;
		this._x = 0;
		this._y = 0;
		this._w = 0;
	...
	,window: function(handle,x,y,w,h,drag) {
		...
		if(handle.layout == 1) {
			w = zui_Zui.t._ELEMENT_W * zui_Zui.SCALE | 0;
		}
		this._w = !handle.scrollEnabled ? w : w - (zui_Zui.t._SCROLL_W * zui_Zui.SCALE | 0);
		this._h = h;
		if(handle.redraws == 0 && !zui_Zui.isScrolling && !zui_Zui.isTyping) {
			return false;
		}
		this.g.begin(true,0);
		this.g.set_color(zui_Zui.t.WINDOW_BG_COL);
	...
	,endWindow: function() {
		...
		if(handle.redraws > 0 || zui_Zui.isScrolling || zui_Zui.isTyping) {
			if(handle.dragEnabled) {
				this.g.set_color(zui_Zui.t.SEPARATOR_COL);
				this.g.fillRect(0,0,this._windowW,15);
			}
			var fullHeight = this._y - handle.scrollOffset;
			if(fullHeight < this._windowH || handle.layout == 1) {
				...
				barH = Math.max(barH,zui_Zui.t._ELEMENT_H * zui_Zui.SCALE);
				var totalScrollableArea = this._windowH - barH;
				var e = amountToScroll / totalScrollableArea;
				var barY = totalScrollableArea * ratio;
				if(this.inputStarted && this.getInputInRect(this._windowX + this._windowW - zui_Zui.t._SCROLL_BAR_W * zui_Zui.SCALE,barY + this._windowY,zui_Zui.t._SCROLL_BAR_W * zui_Zui.SCALE,barH)) {
				...
				if(handle.scrolling) {
					...
					this.scroll(this.inputWheelDelta * (zui_Zui.t._ELEMENT_H * zui_Zui.SCALE),fullHeight);
				}
				...
				this.g.set_color(zui_Zui.t.SCROLL_BG_COL);
				this.g.fillRect(this._windowW - (zui_Zui.t._SCROLL_W * zui_Zui.SCALE | 0),this._windowY,zui_Zui.t._SCROLL_W * zui_Zui.SCALE | 0,this._windowH);
				this.g.set_color(zui_Zui.t.SCROLL_COL);
				this.g.fillRect(this._windowW - zui_Zui.t._SCROLL_BAR_W * zui_Zui.SCALE - this.scrollAlign,barY,zui_Zui.t._SCROLL_BAR_W * zui_Zui.SCALE,barH);
			}
		...
		this.globalG.set_color(zui_Zui.t.WINDOW_TINT_COL);
	...
	,panel: function(handle,text,accent) {
		...
		if(accent > 0) {
			this.g.set_color(accent == 1 ? zui_Zui.t.PANEL_BG1_COL : zui_Zui.t.PANEL_BG2_COL);
			this.g.fillRect(this._x,this._y,this._w,zui_Zui.t._ELEMENT_H * zui_Zui.SCALE);
		}
		this.drawArrow(handle.selected,hover);
		this.g.set_color(hover ? zui_Zui.t.PANEL_TEXT_COL_HOVER : zui_Zui.t.PANEL_TEXT_COL);
	...
	,image: function(image) {
		...
		this.g.set_color(zui_Zui.t.WINDOW_TINT_COL);
	...
	,text: function(text,align,bg) {
		...
		if(bg != 0) {
			this.g.set_color(bg);
			this.g.fillRect(this._x + this.buttonOffsetY,this._y + this.buttonOffsetY,this._w - this.buttonOffsetY * 2,zui_Zui.t._BUTTON_H * zui_Zui.SCALE);
		}
		this.g.set_color(zui_Zui.t.TEXT_COL);
		this.drawStringSmall(this.g,text,zui_Zui.t._DEFAULT_TEXT_OFFSET_X * zui_Zui.SCALE,0,align);
		this.endElement();
	}
	,textInput: function(handle,label) {
		if(label == null) {
			label = "";
		}
		...
		var hover = this.getHover();
		this.g.set_color(hover ? zui_Zui.t.TEXT_INPUT_BG_COL_HOVER : zui_Zui.t.TEXT_INPUT_BG_COL);
		var g = this.g;
		var x = this._x + this.buttonOffsetY;
		var y = this._y + this.buttonOffsetY;
		var w = this._w - this.buttonOffsetY * 2;
		var h = zui_Zui.t._BUTTON_H * zui_Zui.SCALE;
		if(zui_Zui.t.FILL_TEXT_INPUT_BG) {
			g.fillRect(x,y,w,h);
		} else {
			g.drawRect(x,y,w,h,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		}
		if(this.textSelectedHandle != handle && this.getReleased()) {
			...
			this.cursorY = 0;
			this.updateCursorPixelX(handle.text,this.ops.font,this.fontSmallSize);
		...
		if(this.textSelectedHandle == handle) {
			...
			if(this.isKeyDown) {
				if(this.key == kha_Key.LEFT) {
					if(this.cursorX > 0) {
						this.cursorX--;
						this.updateCursorPixelX(text,this.ops.font,this.fontSmallSize);
					}
			...
			if(time % (zui_Zui.t.TEXT_CURSOR_FLASH_SPEED * 2.0) < zui_Zui.t.TEXT_CURSOR_FLASH_SPEED) {
				this.g.set_color(zui_Zui.t.TEXT_CURSOR_COL);
				var cursorHeight = zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - this.buttonOffsetY * 3.0;
				var lineHeight = zui_Zui.t._ELEMENT_H * zui_Zui.SCALE;
				this.g.fillRect(this._x + this.cursorPixelX,this._y + this.cursorY * lineHeight + this.buttonOffsetY * 1.5,zui_Zui.SCALE,cursorHeight);
			}
			this.textSelectedCurrentText = text;
		}
		if(label != "") {
			this.g.set_color(zui_Zui.t.DEFAULT_LABEL_COL);
			this.drawStringSmall(this.g,label,0,0,2);
		}
		this.g.set_color(zui_Zui.t.TEXT_COL);
		if(this.textSelectedHandle != handle) {
			this.drawStringSmall(this.g,handle.text);
		} else {
	...
	,button: function(text) {
		...
		var hover = this.getHover();
		this.g.set_color(pushed ? zui_Zui.t.BUTTON_BG_COL_PRESSED : hover ? zui_Zui.t.BUTTON_BG_COL_HOVER : zui_Zui.t.BUTTON_BG_COL);
		var g = this.g;
		var x = this._x + this.buttonOffsetY;
		var y = this._y + this.buttonOffsetY;
		var w = this._w - this.buttonOffsetY * 2;
		var h = zui_Zui.t._BUTTON_H * zui_Zui.SCALE;
		if(zui_Zui.t.FILL_BUTTON_BG) {
			g.fillRect(x,y,w,h);
		} else {
			g.drawRect(x,y,w,h,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		}
		this.g.set_color(zui_Zui.t.BUTTON_TEXT_COL);
	...
	,check: function(handle,text) {
		...
		this.g.set_color(hover ? zui_Zui.t.TEXT_COL_HOVER : zui_Zui.t.TEXT_COL);
	...
	,separator: function() {
		this.g.set_color(zui_Zui.t.SEPARATOR_COL);
		this.g.fillRect(this._x,this._y,this._w - zui_Zui.t._DEFAULT_TEXT_OFFSET_X * zui_Zui.SCALE,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		this._y += 2;
	}
	,drawArrow: function(selected,hover) {
		var x = this._x + this.arrowOffsetX;
		var y = this._y + this.arrowOffsetY;
		this.g.set_color(hover ? zui_Zui.t.ARROW_COL_HOVER : zui_Zui.t.ARROW_COL);
		if(selected) {
			this.g.fillTriangle(x,y,x + zui_Zui.t._ARROW_W * zui_Zui.SCALE,y,x + zui_Zui.t._ARROW_W * zui_Zui.SCALE / 2,y + zui_Zui.t._ARROW_H * zui_Zui.SCALE);
		} else {
			this.g.fillTriangle(x,y,x,y + zui_Zui.t._ARROW_H * zui_Zui.SCALE,x + zui_Zui.t._ARROW_W * zui_Zui.SCALE,y + zui_Zui.t._ARROW_H * zui_Zui.SCALE / 2);
		}
	}
	,drawCheck: function(selected,hover) {
		var x = this._x + this.checkOffsetX;
		var y = this._y + this.checkOffsetY;
		this.g.set_color(hover ? zui_Zui.t.CHECK_COL_HOVER : zui_Zui.t.CHECK_COL);
		var g = this.g;
		var w = zui_Zui.t._CHECK_W * zui_Zui.SCALE;
		var h = zui_Zui.t._CHECK_H * zui_Zui.SCALE;
		if(zui_Zui.t.FILL_CHECK_BG) {
			g.fillRect(x,y,w,h);
		} else {
			g.drawRect(x,y,w,h,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		}
	...
	,drawRadio: function(selected,hover) {
		...
		this.g.set_color(hover ? zui_Zui.t.RADIO_COL_HOVER : zui_Zui.t.RADIO_COL);
		var g = this.g;
		var w = zui_Zui.t._RADIO_W * zui_Zui.SCALE;
		var h = zui_Zui.t._RADIO_H * zui_Zui.SCALE;
		if(zui_Zui.t.FILL_RADIO_BG) {
			g.fillRect(x,y,w,h);
		} else {
			g.drawRect(x,y,w,h,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		}
		if(selected) {
			this.g.set_color(zui_Zui.t.RADIO_SELECT_COL);
			this.g.fillRect(x + this.radioSelectOffsetX,y + this.radioSelectOffsetY,zui_Zui.t._RADIO_SELECT_W * zui_Zui.SCALE,zui_Zui.t._RADIO_SELECT_H * zui_Zui.SCALE);
		}
	}
	,drawInlineRadio: function(text,hover) {
		if(hover) {
			this.g.set_color(zui_Zui.t.RADIO_COL_HOVER);
			this.g.fillRect(this._x + 5,this._y + 5,this._w - 10,zui_Zui.t._ELEMENT_H * zui_Zui.SCALE - 10);
		}
		var x = this._x + this.arrowOffsetX;
		var y = this._y + this.arrowOffsetY;
		this.g.set_color(hover ? zui_Zui.t.ARROW_COL_HOVER : zui_Zui.t.ARROW_COL);
		this.g.fillTriangle(x,y,x,y + zui_Zui.t._ARROW_H * zui_Zui.SCALE,x - zui_Zui.t._ARROW_W * zui_Zui.SCALE / 2,y + zui_Zui.t._ARROW_H * zui_Zui.SCALE / 2);
		var x1 = this._x + this._w - this.arrowOffsetX - 5;
		this.g.fillTriangle(x1,y,x1,y + zui_Zui.t._ARROW_H * zui_Zui.SCALE,x1 + zui_Zui.t._ARROW_W * zui_Zui.SCALE / 2,y + zui_Zui.t._ARROW_H * zui_Zui.SCALE / 2);
		this.g.set_color(hover ? zui_Zui.t.TEXT_COL_HOVER : zui_Zui.t.TEXT_COL);
	...
	,drawSlider: function(value,from,to,filled,hover) {
		...
		var g = this.g;
		var h = zui_Zui.t._BUTTON_H * zui_Zui.SCALE;
		if(zui_Zui.t.FILL_SLIDER_BG) {
			g.fillRect(x,y,w,h);
		} else {
			g.drawRect(x,y,w,h,zui_Zui.t._LINE_STRENGTH * zui_Zui.SCALE);
		}
		this.g.set_color(hover ? zui_Zui.t.SLIDER_COL_HOVER : zui_Zui.t.SLIDER_COL);
		...
		this.g.fillRect(sliderX,y,sliderW,zui_Zui.t._BUTTON_H * zui_Zui.SCALE);
	}
	,drawString: function(g,text,xOffset,yOffset,align) {
		...
		if(xOffset == null) {
			xOffset = zui_Zui.t._DEFAULT_TEXT_OFFSET_X;
		}
		...
		if(align == 1) {
			...
			xOffset = this._w - this.ops.font.width(this.fontSize,text) - zui_Zui.t._DEFAULT_TEXT_OFFSET_X * zui_Zui.SCALE;
		}
	...
	,drawStringSmall: function(g,text,xOffset,yOffset,align) {
		...
		if(align == 1) {
			...
			xOffset = this._w - this.ops.font.width(this.fontSmallSize,text) - zui_Zui.t._DEFAULT_TEXT_OFFSET_X * zui_Zui.SCALE;
		}
	...
	,endElement: function(nextLine) {
		...
		if(this.currentWindow.layout == 0) {
			if(this.curRatio == -1 || this.ratios != null && this.curRatio == this.ratios.length - 1) {
				if(nextLine) {
					this._y += zui_Zui.t._ELEMENT_H * zui_Zui.SCALE + zui_Zui.t._ELEMENT_SEPARATOR_SIZE * zui_Zui.SCALE;
				}
			...
			this._x += this._w + zui_Zui.t._ELEMENT_SEPARATOR_SIZE * zui_Zui.SCALE;
		}
	}
	,row: function(ratios) {
		this.ratios = ratios;
	...
	,indent: function() {
		this._x += zui_Zui.t._TAB_W * zui_Zui.SCALE | 0;
		this._w -= zui_Zui.t._TAB_W * zui_Zui.SCALE | 0;
	}
	,unindent: function() {
		this._x -= zui_Zui.t._TAB_W * zui_Zui.SCALE | 0;
		this._w += zui_Zui.t._TAB_W * zui_Zui.SCALE | 0;
	...
	,getInitialHover: function() {
		if(this.inputInitialX >= this._windowX + this._x && this.inputInitialX < this._windowX + this._x + this._w && this.inputInitialY >= this._windowY + this._y) {
			return this.inputInitialY < this._windowY + this._y + zui_Zui.t._ELEMENT_H * zui_Zui.SCALE;
		} else {
			return false;
		}
	}
	,getHover: function() {
		if(this.inputX >= this._windowX + this._x && this.inputX < this._windowX + this._x + this._w && this.inputY >= this._windowY + this._y) {
			return this.inputY < this._windowY + this._y + zui_Zui.t._ELEMENT_H * zui_Zui.SCALE;
		} else {
			return false;
		}
	}
	...
	,updateCursorPixelX: function(text,font,fontSize) {
		var str = HxOverrides.substr(text,0,this.cursorX);
		this.cursorPixelX = this.ops.font.width(fontSize,str) + zui_Zui.t._DEFAULT_TEXT_OFFSET_X * zui_Zui.SCALE;
	}
...
zui_Handle.prototype = {
	...
	,nest: function(i,ops) {
		...
		while(this.children.length <= i) this.children.push(new zui_Handle(ops));
...
zui_Id.i = 0;
zui_Themes.dark = { _FONT_SIZE : 17, _FONT_SMALL_SIZE : 16, _ELEMENT_W : 100, _ELEMENT_H : 30, _ELEMENT_SEPARATOR_SIZE : 0, _ARROW_W : 9, _ARROW_H : 9, _BUTTON_H : 21, _CHECK_W : 15, _CHECK_H : 15, _CHECK_SELECT_W : 9, _CHECK_SELECT_H : 9, _RADIO_W : 15, _RADIO_H : 15, _RADIO_SELECT_W : 9, _RADIO_SELECT_H : 9, _SCROLL_W : 12, _SCROLL_BAR_W : 8, _DEFAULT_TEXT_OFFSET_X : 8, _TAB_W : 12, _LINE_STRENGTH : 2, WINDOW_BG_COL : -16777216, WINDOW_TINT_COL : -570425345, SCROLL_BG_COL : -15724528, SCROLL_COL : -11974327, SCROLL_HOVER_COL : -2894893, PANEL_BG1_COL : -16777216, PANEL_BG2_COL : -16777216, PANEL_TEXT_COL : -9211280, PANEL_TEXT_COL_HOVER : -9211280, BUTTON_BG_COL : -11175241, BUTTON_TEXT_COL : -3487289, BUTTON_BG_COL_HOVER : -10055985, BUTTON_BG_COL_PRESSED : -3299061, TEXT_INPUT_BG_COL : -13355978, TEXT_INPUT_BG_COL_HOVER : -12303290, TEXT_CURSOR_COL : -3487289, TEXT_CURSOR_FLASH_SPEED : 0.5, CHECK_COL : -13355978, CHECK_COL_HOVER : -12303290, CHECK_SELECT_COL : -2697514, RADIO_COL : -13355978, RADIO_COL_HOVER : -12303290, RADIO_SELECT_COL : -2697514, SLIDER_COL : -13355978, SLIDER_COL_HOVER : -12303290, TEXT_COL : -3487289, TEXT_COL_HOVER : -3487289, DEFAULT_LABEL_COL : -5592406, ARROW_COL : -3487289, ARROW_COL_HOVER : -3487289, SEPARATOR_COL : -14540513, FILL_TEXT_INPUT_BG : false, FILL_BUTTON_BG : true, FILL_CHECK_BG : false, FILL_RADIO_BG : false, FILL_SLIDER_BG : false};
zui_Themes.light = { _FONT_SIZE : 20, _FONT_SMALL_SIZE : 18, _ELEMENT_W : 100, _ELEMENT_H : 40, _ELEMENT_SEPARATOR_SIZE : 0, _ARROW_W : 9, _ARROW_H : 9, _BUTTON_H : 21, _CHECK_W : 15, _CHECK_H : 15, _CHECK_SELECT_W : 9, _CHECK_SELECT_H : 9, _RADIO_W : 15, _RADIO_H : 15, _RADIO_SELECT_W : 9, _RADIO_SELECT_H : 9, _SCROLL_W : 12, _SCROLL_BAR_W : 8, _DEFAULT_TEXT_OFFSET_X : 8, _TAB_W : 12, _LINE_STRENGTH : 2, WINDOW_BG_COL : -5592406, WINDOW_TINT_COL : -570425345, SCROLL_BG_COL : -5592406, SCROLL_COL : -2894893, SCROLL_HOVER_COL : -2894893, PANEL_BG1_COL : -4210753, PANEL_BG2_COL : -4210753, PANEL_TEXT_COL : -15198184, PANEL_TEXT_COL_HOVER : -15198184, BUTTON_BG_COL : -2368549, BUTTON_TEXT_COL : -15198184, BUTTON_BG_COL_HOVER : -1710619, BUTTON_BG_COL_PRESSED : -11108158, TEXT_INPUT_BG_COL : -8158333, TEXT_INPUT_BG_COL_HOVER : -7303024, TEXT_CURSOR_COL : -3487289, TEXT_CURSOR_FLASH_SPEED : 0.5, CHECK_COL : -11305794, CHECK_COL_HOVER : -10253138, CHECK_SELECT_COL : -2697514, RADIO_COL : -12369085, RADIO_COL_HOVER : -11513776, RADIO_SELECT_COL : -2697514, SLIDER_COL : -11305794, SLIDER_COL_HOVER : -10976313, TEXT_COL : -15527149, TEXT_COL_HOVER : -1, DEFAULT_LABEL_COL : -14277082, ARROW_COL : -11382190, ARROW_COL_HOVER : -1, SEPARATOR_COL : -7697782, FILL_TEXT_INPUT_BG : true, FILL_BUTTON_BG : true, FILL_CHECK_BG : true, FILL_RADIO_BG : true, FILL_SLIDER_BG : false};
zui_Zui.isScrolling = false;
zui_Zui.isTyping = false;
