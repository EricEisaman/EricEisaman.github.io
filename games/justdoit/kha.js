...
Project.prototype = {
	...
	,render: function(framebuffer) {
		...
		graphics.drawString("Showing Box : " + Std.string(this.box.isShowing),0,320);
		graphics.drawString("Box X : " + this.box_x,0,360);
		graphics.drawString("Box Y : " + this.box_y,0,400);
		if(this.motivate) {
		...
		if(this.ui.window(zui_Handle.global.nest(0,null),0,0,300,300)) {
			if(this.ui.panel(zui_Handle.global.nest(1,null),"CONTROL PANEL",10)) {
				if(this.ui.button("ZUI Demo")) {
					haxe_Log.trace("Hello ZUI!",{ fileName : "Project.hx", lineNumber : 66, className : "Project", methodName : "gui"});
				}
